      ...
      <div ref={ref} className="relative w-full pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-12 md:pt-24 md:gap-10">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start md:w-full min-w-[80px] md:min-w-0">
              <div className="h-8 md:h-10 absolute left-2 md:left-3 w-8 md:w-10 rounded-full bg-white dark:bg-dark-base flex items-center justify-center">
        ...
        <div
          ...
          className="absolute md:left-8 left-2 top-0 overflow-hidden w-0.5 md:w-1 bg-gradient-to-b from-[#8b5cf6] to-[#6366f1]"
        >
          <motion.div
            style={{
              height: height + 'px',
